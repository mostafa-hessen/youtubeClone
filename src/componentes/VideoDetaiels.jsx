  ...
  return (
    <div className="container-fluid  videoDetaiels">
      <div className="row">
        <div className="col-12  col-lg-9">
          <div className="plyr__video-embed" id="player">
            <iframe
              ...
              allow="autoplay"
            ></iframe>
             <div className="detiles row justify-content-between">
                  <div className="col-6">
                      <div className="imgchannel&Name">
                              <div className="img" style={{width:"80px",height:"80px"}}>
                                {console.log(relatedVideos?.['items'])}
                                {/* <img src={targetVideo?.snippet.thumbnails.high.url} alt="channelImg" style={{height:"100%"}} /> */}
                              </div>
                              {/* <h4>{targetVideo?.items[0].title}</h4> */}
                      </div>
                  </div>
        ...
        <div className="col-12 col-lg-3 row  " style={{height:"80vh",overflowY:"scroll"}} >
          {console.log(relatedVideos)}
          {relatedVideos?.items?.map(ele=><div className="col-12 col-md-4 col-lg-12"><YoutubeCard video={ele}/></div>)}
        </div>
      </div>
    </div>
  );
